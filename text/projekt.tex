...
%==============================================================================
\documentclass[print]{fitthesis} % bez zadání - pro začátek práce, aby nebyl problém s překladem
...
\projectinfo{
  ...
  title.cs={
Lego MindstormS EV3 ve výuce programování a robotiky},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Lego MindstormS EV3 in Education of Programming and Robotics}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
...
\begin{document}
  ...
  \input{projekt-02-historie-lego-mindstorms}
  
  \input{projekt-03-available-platforms}
      
  \input{projekt-04-testovani}
  
  \input{projekt-05-vyvojova-platforma}
