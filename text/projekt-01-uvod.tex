...
Jakmile jsme ale chtěli mít regulační smyčku PID~regulace pro robota na sledování černé čáry s periodou 10~ms, zjistili jsme, že to nejde (a to máme v EV3 \brick{\it u} 300~MHz~ARMa). Přitom díky předešlým zkušenostem s 8-bitovými mikrokontroléry Atmel~AVR jsme věděli, že by to neměl být problém.
