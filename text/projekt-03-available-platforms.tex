...
% * <paral.jarek@gmail.com> 2017-05-11T12:27:44.817Z:
% 
% > Dostupné platformy
% Ukázkový komentář. Stačí označit pasáž, kterou chceš okomentovat a kliknout na "+" v horní liště  (a je potřeba být v módu Rich Text).
% 
% ^.
...
Jako nejdůležitější bod bych považoval nepřehlednost rozsáhlejších programů. % a nemožnost ladění a úpravy uživatelských bloků. 
...
% * <kuba.streit@gmail.com> 2017-05-11T18:59:36.020Z:
% 
% > na portovány
% Tohle by mělo být jedno slovo, ale za jeho češtinství bych ruku do ohně nedal.
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T19:59:40.841Z:
%
% Upraveno. OK?
%
% ^.
...
Jako zajímavost lze dodat, že tento systém podporuje i~alternativní \brick{\it y} postavené na jednodeskových počítačích Raspberry~Pi nebo BeagleBone. Příkladem komerčně prodávaných \brick{\it ů} jsou BrickPi od~Dexter Industries~\cite{lego_dexterindustries_brickpi} a PiStorms od mindsensors.com~\cite{lego_mindsensor_pistorms}.
...
% Také přístup k~jednotlivým driverům (motory a~senzory) je značně pomalý a~degraduje výkon interního 300~MHz procesoru.
% Při procházení implementace jsem zjistil, že veškerá obsluha motorů a senzorů je prováděna přes zápis a čtení souborů, což by mohlo být místo, které se značně podílí na degradaci výkonu.
% * <kuba.streit@gmail.com> 2017-05-11T19:17:42.522Z:
% 
% > degradaci výkonu
% Také bych zmínil, že používat textové rozhraní v tomto případě je mírně řečeno velmi nehezké ("on", "off").
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T20:03:04.887Z:
% 
% Ha vidíš to, to jsem si vůbec neuvědomil :-).
% 
% Přepracovat
% 
% ^ <paral.jarek@gmail.com> 2017-05-14T16:48:47.741Z.
...
% * <kuba.streit@gmail.com> 2017-05-11T19:23:05.422Z:
% 
% > Příklad v~C++~API jsem vybral z~důvodu mých předešlých zkušenosti s tímto rozhraním a předpokladu, že by u~C++ nemělo docházet k~degradaci výkonu, což by mohlo nastávat u interpretovaných programovacích jazyků jako Python nebo JavaScript.
% 
% To je věta přes 3 řádky - nešla by trochu rozdělit?
% 
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T20:34:57.785Z:
%
% Přepracuji celé, viz další komentář.
%
% ^ <paral.jarek@gmail.com> 2017-05-13T20:03:55.409Z:
%
% Bohužel asi to už lépe nevymyslím :-(.
%
% ^.
% 

Z~mých dlouhodobých zkušenosti s~začátečníky mám dobrou představu, jakých chyb se nejčastěji dopouští a co jim dělá největší problém.
...
% * <email@honzamrazek.cz> 2017-05-11T13:50:56.533Z:
% 
% Opravdu protot? Není to proto, že denně pracuješ se začátečníky?
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T16:42:56.414Z:
%
% Zde jsem chtěl zachytit tu myšlenku, že vím, čím si musí začátečník s EV3DEV (bez naší knihovny) projít, protože jsem si tím sám prošel a vím jak se některé věci v C++ API musí řešit složitě. 
% Ale asi to tak nevyznívá, že? 
% Teď si ale nejsem jistý do jaké podoby to tedy opravit. Zda se snažit vypíchnout tu náročnost C++ API a nebo tedy ty poje "každodenní zkušenosti s začátečníky". Co myslíš?  
%
% ^ <paral.jarek@gmail.com> 2017-05-11T18:38:33.864Z:
%
% Z každodenní zkušenosti s začátečníky ... -> i tak to neřeší problémy daného systému
%
% ^ <kuba.streit@gmail.com> 2017-05-11T19:25:38.693Z:
%
% Z tvé zkušenosti se začátečníky vyplývá praktická nepoužitelnost jejich API.
%
% ^ <paral.jarek@gmail.com> 2017-05-13T20:03:55.409Z:
%
% Přepracováno. OK?
...
Kvůli nedostatečnému výkonu \brick{\it u}, na samotném EV3 kompletní ROS neběží.
...
EV3 tyto příkazy běžně využívá v~režimu Daisy-Chain, kdy lze USB kabely spojit do série až~čtyři \brick{\it y} a~řídit je jedním programem.     
...
A~až na to, že není v češtině, ji není co vytknout. % CHECK: myšleno s nadsázkou :-)  
...
% * <kuba.streit@gmail.com> 2017-05-11T19:39:36.805Z:
% 
% >  \$79, \$299, \$599
% Nechceš to taky přepočítat a ocitovat?
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T20:26:50.571Z:
%
% Přemýšlel jsem o tom. Myslíš, že by to bylo lepší?
%
% ^ <kuba.streit@gmail.com> 2017-05-11T20:35:30.155Z:
%
% Nevím, asi, ale tu citaci určitě.
%
% ^ <paral.jarek@gmail.com> 2017-05-14T10:26:50.571Z:
% 
% Citace přidána.
% Mám přepočítat ty částky do korun?
% 
% ^.
...
% * <paral.jarek@gmail.com> 2017-05-11T17:05:54.029Z:
% 
% > real-timovost
% Můžu to takhle napsat?
% 
% ^.
...
% * <kuba.streit@gmail.com> 2017-05-11T20:24:34.069Z:
% 
% Co tu tabulku transponovat?
% 
% ^ <paral.jarek@gmail.com> 2017-05-11T20:26:15.161Z:
%
% Myslíš jako dát systémy na první řádek a body 1 - 8 do prvního sloupce? 
%
% ^ <kuba.streit@gmail.com> 2017-05-11T20:27:07.134Z:
%
% jj, a vypsal bych je tam, čísla hrozně zdržují od čtení a demotivují
%
% ^.
